...
// uses a condition that only the elements that pass that condition will be added
const depositMovements = movements.filter(function (mov, i, arr) {
  return mov > 0;
});

const withdrawMovements = movements.filter(mov => mov < 0);

console.log(withdrawMovements);
