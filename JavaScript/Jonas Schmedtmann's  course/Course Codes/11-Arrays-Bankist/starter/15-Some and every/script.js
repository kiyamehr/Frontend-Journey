...
// Equality
console.log(movements.includes(-130)); // True / False

// Some: Condition
// checks if a condition is true
console.log(movements.some(mov => mov < -100)); // True / False

// Every
// checks if all the elements pass the condition
console.log(movements.every(mov => mov > 0));
console.log(account4.movements.every(mov => mov > 0));

// Seperate callback funciton
