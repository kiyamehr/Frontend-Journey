...
// flat
const arr = [[1, 2, 3], 4, 5, 5, [1, 5, 2, 1, 2]];
const arrDeep = [[1, [2, 3, 1, 3], 2, 3], 4, 5, 5, [1, 5, 2, 1, 2]];

console.log(arr.flat()); // returns one array with all nested arrays chained togehter
console.log(arrDeep.flat(2)); // but it goes only one level deep

const overAllBalance = accounts
  .map(acc => acc.movements) // returns an array of arrays
  .flat() // flattens the array by removing nested arrays and make them one
  .reduce((acc, mov) => acc + mov); // sum of arrays
console.log(overAllBalance);

// flat map
// a map that flats in the end
