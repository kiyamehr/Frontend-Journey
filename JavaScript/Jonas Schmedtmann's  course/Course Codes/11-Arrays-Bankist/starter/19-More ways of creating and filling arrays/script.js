...
const displayMovements = function (movements, sort = false) {
  ...
  // since sort mutates the array we use slice() to copy it and not change the original array
...
btnLoan.addEventListener('click', function (e) {
  ...
  // searching if there was 'any' element that was the 10 percent of the requested loan (returns true or false)
...
x.fill(1); // Mutates the main array
// console.log(x);

// fill works like slice and we can give start and ending indexes
...
const z = Array.from({ length: 10 }, (_, i) => i + 1); // first argument: current number , sacond: index
console.log(z);

const dice = Array.from({ length: 100 }, () => Math.trunc(Math.random() * 101));
console.log(dice);

// Converting node array in to Real array
